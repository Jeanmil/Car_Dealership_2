...
//        try {
//            String sql = "INSERT INTO payment_project(paymentID, paidDate, amountPaid) VALUES (?, ?, ?)";
...
//                    + "FROM payments ORDER BY vin"; // Our SQL query
//            stmt = connection.prepareStatement(sql);
...
//                    + "WHERE c.username = ? ORDER BY c.vin"; // Our SQL query
//            stmt = connection.prepareStatement(sql);
//            
